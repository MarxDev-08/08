...
import Img1 from "../assets/samratImg.jpg";
import Img2 from "../assets/PMimg.jpg";
import Img3 from "../assets/Saudamini.img.jpg";
import Img4 from "../assets/sandeepimg.jpg";
import Img5 from "../assets/Amimg.jpg";
      ...
      <div className="row g-4 justify-content-center">
        ...
        <div className="col-md-4 col-sm-6 col-12 d-flex justify-content-center">
          <div className="Mycard card border-0">
            <img src={Img1} className="card-img-top rounded" alt="Card 1" />
        ...
        <div className="col-md-4 col-sm-6 col-12 d-flex justify-content-center">
          <div className="Mycard card border-0">
            <img src={Img5} className="card-img-top rounded" alt="Card 5" />
            <div className="overlay">
              <h4>Amami</h4>
              <p>
                {" "}
