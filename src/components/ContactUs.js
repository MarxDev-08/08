...
import FooterImg from "../assets/marxdevlogo.png";
  ...
  return (
    <>
        ...
        <div className="contact-info">
          ...
          <p>
            ...
            <a
              ...
              href="mailto:marxdev09111@gmail.com"
            >
          ...
          <p className="small text-muted">
            ...
            Web Engineering" project at the University of Technology Chemnitz.
          </p>
        </div>
      </div>
      ...
      <footer id="footer">
        ...
        <p>
          Contact us: <a href="mailto:Marxdev0911@.com">Marxdev0911@.com</a>
        </p>
        <p>
          © Copyright 2025, All Rights Reserved By <strong>Marx.dev</strong>
        </p>
      </footer>
    </>
  );
